...
@WebServlet("/cars-under-repair-admin")
public class CarListAllUnderRepairServlet extends HttpServlet {
    private final CarService carService = ServiceFactory.getInstance().getCarService();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        List<CarAdminResponseDto> cars = CarMapper.toDtos(carService.findAllCustomCarsUnderRepaired());
