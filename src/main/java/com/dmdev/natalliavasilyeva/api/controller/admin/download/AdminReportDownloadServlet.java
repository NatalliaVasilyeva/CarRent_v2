package com.dmdev.natalliavasilyeva.api.controller.admin.download;
...
public class AdminReportDownloadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        List<OrderResponseDto> orderResponseDtoList = OrderMapper.toDtos(orderService.getAllCustomOrders());
