...
public final class VariablesNameHolder {
    ...
    public static final String START_RENTAL_DATE = "startRentalDate";
    public static final String END_RENTAL_DATE = "endRentalDate";
    ...
    public static final String IS_REPAIRED = "isRepaired";
    public static final String IS_INSURANCE_NEEDED = "isInsuranceNeeded";
