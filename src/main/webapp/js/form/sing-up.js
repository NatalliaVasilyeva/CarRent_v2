$(function () {
    $(".signupbtn").click(function () {
        ...
        const isValid = validateSignUpForm(login, name, surname, email, phone, address, birthday, password, repeat_password);
        if (!isValid) {
            return;
        }
        $.post("sign-up",
...
function validateSignUpForm(login, name, surname, email, phone, address, birthday, password, repeat_password) {
    let errorMessage = {};
    if (!login) {
    ...
    showSignUpErrors(errorMessage.login, errorMessage.name, errorMessage.surname, errorMessage.email, errorMessage.phone,
        errorMessage.address, errorMessage.birthday, errorMessage.password, errorMessage.repeat_password);
    return $.isEmptyObject(errorMessage);
}

function showSignUpErrors(loginMsg, nameMsg, surnameMsg, emailMsg, phoneMsg, addressMsg, birthdayMsg, passwordMsg, repeat_passwordMsg) {
